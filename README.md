...
The 'valuation_lakehouse' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/valuation_lakehouse/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] valuation_lakehouse_etl` to your workspace.
